...
planepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = planepage.messages(null, null, opt_ijData) + '<table width="100%"><tr><td><h1><a href="https://developers.google.com/blockly/">Blockly</a>&rlm; &gt; <a href="../codeElement.html">Demos</a>&rlm; &gt; <span id="title">Calculator pentru locurile dintr-un avion</span> &nbsp; ';
