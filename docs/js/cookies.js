...
const COOKIE_SIGNED_UP = "COOKIE_SIGNED_UP";
const COOKIE_SIGN_UP_IN_PROGRESS = "COOKIE_SIGN_UP_IN_PROGRESS";
const COOKIE_SIGN_UP_PHONE_NUMBER = "COOKIE_SIGN_UP_PHONE_NUMBER";
const COOKIE_USER_ID = "COOKIE_USER_ID";
const COOKIE_USER_FIRSTNAME = "COOKIE_USER_FIRSTNAME";
const COOKIE_USER_LASTNAME = "COOKIE_USER_LASTNAME";
